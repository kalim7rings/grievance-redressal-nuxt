<template>
    <div class="hdfc-grievance-footer">
        <div class="contact-info hdfc-webform-footerlinks-wrapper">
            <div class="socialConnect-block">
                <a class="socialIcon linkedin" href="https://www.linkedin.com/company/hdfc?trk=top_nav_home" target="_blank" title="LinkedIn">
                ...
                <a class="socialIcon twtr" href="https://twitter.com/HomeLoansByHDFC" target="_blank" title="Twitter">
                ...
                <a class="socialIcon fb" href="https://www.facebook.com/HDFCHomeLoanExperts" target="_blank" title="Facebook">
                ...
                <a class="socialIcon youTube" href="https://www.youtube.com/user/hdfcltd" target="_blank" title="YouTube">
        ...
        <div class="hdfc-grievance-copyright">
            <p> &copy; 2019. HDFC Ltd. All Rights Reserved.</p>
        </div>
    </div>
</template>
<script>
